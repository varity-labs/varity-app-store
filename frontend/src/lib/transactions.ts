...
export function handleTransactionError(error: unknown): string {
  ...
  if (
    ...
    return "Transaction was rejected. Please try again and approve the transaction.";
  }
  ...
  if (errorMessage.includes("App not found")) {
    return "Application not found. It may have been removed.";
  }
  ...
  if (errorMessage.includes("Only developer")) {
    return "Only the app developer can perform this action.";
  }
