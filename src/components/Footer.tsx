...
// Custom Discord icon (not in lucide-react)
...
// Custom Reddit icon (not in lucide-react)
        ...
        <div className="grid gap-12 md:grid-cols-5">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-4 max-w-sm text-body-sm text-foreground-secondary">
              Discover quality enterprise applications for your business. Browse our curated collection of verified tools and services.
            </p>
            {/* Social Links */}
            <div className="flex items-center gap-4 mt-6">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="text-foreground-muted hover:text-brand-400 transition-colors"
                  aria-label={`Follow Varity on ${social.label}`}
                >
